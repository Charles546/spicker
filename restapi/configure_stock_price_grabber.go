...
import (
	...
	appMiddlewares "github.com/Charles546/spicker/v2/middlewares"
...
func configureFlags(api *operations.StockPriceGrabberAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.StockPriceGrabberAPI) http.Handler {
	...
	if api.StockpricesHandler == nil {
		api.StockpricesHandler = operations.StockpricesHandlerFunc(func(params operations.StockpricesParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.Stockprices has not yet been implemented")
		})
	}
...
func setupGlobalMiddleware(handler http.Handler) http.Handler {
	return appMiddlewares.Expires(handler)
}
